# ispitch-api/src/analysis/domain/utils/text_segmenter.py
...
def segment_transcription(
    ...
    Args:
        ...
        pause_threshold_ms: O tempo em milissegundos para considerar uma pausa longa.

    Yields:
        Um dicionário representando um segmento de texto com start_time, end_time e text.
    """
    if not words:
        return
    ...
    for i, word in enumerate(words):
        ...
        # Verifica se a palavra atual termina com uma pontuação de fim de sentença
        ends_with_punctuation = word.word.strip().endswith(tuple(sentence_punctuations))
        ...
        # Se for a última palavra, ou se houver pontuação ou uma pausa longa, fecha o segmento
